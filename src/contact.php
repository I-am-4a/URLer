...
<div id="contents">
	...
	<div id="main">
		...
		<a href="https://twitter.com/share" class="twitter-share-button" data-url="http://urler.cf/contact.php" data-text="URLer" data-via="I_am_4a" data-size="100" data-related="I_am_4a" data-count="horizontal" data-hashtags="URLer">Tweet</a> 
...
<script>(function(d, s, id) {
  ...
  fjs.parentNode.insertBefore(js, fjs);
		...
		<?endif;?>
		<h2>お問い合わせフォーム</h2>
			<a href="https://www.secure-cloud.jp/sf/1518966395TZACFXgQ" target="_blank">お問い合わせフォーム <i class="fas fa-sign-out-alt"></i></a>よりお願いします。
		<h2>更新情報</h2>
		<dl class="info">
