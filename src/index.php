...
<script>(function(d, s, id) {
  ...
  fjs.parentNode.insertBefore(js, fjs);
		...
		<h2>What is "URLer"?</h2>
		<p>
			URLerは、ログイン不要で簡単にURLを短縮できるサイトです。<br>
			URL短縮をしたい方は、<a href="#shorten">URL短縮</a>よりどうぞ。<br>
			APIの利用は、<a href="api.php"><i class="fas fa-wrench"></i> API</a>より。
		</p>
		<h2><a name="shorten" class="ignorecss">URL短縮</a></h2>
		<p>
			URLを入力して、「送信」を押して下さい。<br>
			<strong>現在のURL作成数: <?=sprintf("%06d", count(json_decode(file_get_contents("./bin/urls.json"), true)))?></strong>
		</p>
		<form method="POST" action="./urlgen.php">
			<input name="longUrl" placeholder="例) http://www.iam4a.ml/" size="50">
			<input type="hidden" name="key" value="<? print $key ?>" /><input type="submit" value="送信">
		</form>
		<h2>更新情報</h2>
		<dl class="info">
